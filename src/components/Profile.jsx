...
export default function Profile() {
  ...
  return (
    <div className="max-w-sm mx-4 z-2 sm:max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg mx-auto mt-8 shadow-xl rounded-lg text-gray-900">
      ...
      <div className="relative -mt-16 z-2 mx-auto w-24 h-24 sm:w-32 sm:h-32 border-4 border-white bg-white rounded-full overflow-hidden">
        <Image
          width={120}
          height={120}
      ...
      <div className="text-center mt-4 z-2">
        <h2 className="text-xl font-semibold">{user.name}</h2>
        <p className="text-gray-500 mt-1">{user.email}</p>
      </div>
      <div className="p-4 border-t mx-4 mt-4 z-2">
        <button
